...
## SYNOPSIS
This function will create a new Project Ticket [TODO].

## SYNTAX

```
New-CWMProjectTicket [-ProjectID] <Int32> [-PhaseID] <Int32> [-Summary] <String> [[-id] <Int32>] [[-hours] <Decimal>] [-member] <Object>
