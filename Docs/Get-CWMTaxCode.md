...
## SYNOPSIS
This function will list currency codes.

## SYNTAX

```
Get-CWMTaxCode [[-Condition] <String>] [[-orderBy] <String>]
...
### EXAMPLE 1
```powershell
Get-CWMTaxCode -CompanyID 1 -all
```
...
[https://developer.connectwise.com/products/manage/rest?a=Finance&e=TaxCodes&o=GET](https://developer.connectwise.com/products/manage/rest?a=Finance&e=TaxCodes&o=GET)
