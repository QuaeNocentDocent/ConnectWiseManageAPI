...
```
Get-CWMCurrencyCode [[-Condition] <String>] [[-orderBy] <String>]
...
[https://developer.connectwise.com/products/manage/rest?a=Company&e=CompanySites&o=GET](https://developer.connectwise.com/products/manage/rest?a=Company&e=CompanySites&o=GET)
